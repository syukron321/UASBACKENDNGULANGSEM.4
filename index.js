...
const routeDaftarHp = require("./routers/daftar_hp");
const routeNilaiHp = require("./routers/nilai_hp");
const routeDataHp = require("./routers/data_hp");
...
app.use(routeDaftarHp);
app.use(routeNilaiHp);
app.use(routeDataHp);
